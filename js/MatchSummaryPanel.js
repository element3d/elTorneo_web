...
export default function MatchSummaryPanel({match, summary}) {
    ...
    return (<div className={styles.cont}>
       ...
       <div className={styles.panel}>
        <img className={match.league == 7 ? styles.team_flag : styles.team_kit} src={getTeamImg(match.team1)}/>
        ...
        <img className={ match.league == 7 ? styles.team_flag : styles.team_kit } src={getTeamImg(match.team2)}/>
       </div>
    </div>)
}